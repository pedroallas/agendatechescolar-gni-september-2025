  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const resourceData = {
      ...
      quantity: resource.quantity
        ? Number.parseInt(resource.quantity)
        : undefined,
      capacity: resource.capacity
        ? Number.parseInt(resource.capacity)
        : undefined,
    };
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || "Falha ao criar recurso");
      }

      router.push("/dashboard/resources");
    } catch (error: any) {
      console.error("Erro ao criar recurso:", error);
      setError(error.message || "Ocorreu um erro ao criar o recurso");
    } finally {
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-6 flex items-center">
        ...
        <h1 className="text-2xl font-bold">Novo Recurso</h1>
      </div>
      ...
      <Card className="max-w-2xl mx-auto">
        <CardHeader>
          ...
          <CardDescription>
            Preencha as informações abaixo para adicionar um novo recurso.
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="col-span-2 space-y-4">
                <div className="flex items-center justify-between p-4 border rounded-lg bg-muted/50">
                  ...
                  <Switch
                    id="requiresApproval"
                    checked={resource.requiresApproval}
